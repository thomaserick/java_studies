...
//	private final ResponseMessage m201 = simpleMessage(201, "Recurso criado");
	...
	public Docket api() {
		return new Docket(DocumentationType.SWAGGER_2)
				...
				.select()
				// Pacotes para rastreio
				.apis(RequestHandlerSelectors.basePackage("com.tef.cursomc.resources"))
	...
	private ApiInfo apiInfo() {
		return new ApiInfo("API do curso Spring Boot",
				...
				new Contact("Thomas Erick", "https://github.com/thomaserick", "thominhaserick@gmail.com"),
